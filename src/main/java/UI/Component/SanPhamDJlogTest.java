 ...
 * @author ADMIN
 */
public class SanPhamDJlogTest extends javax.swing.JFrame {
    /**
     * Creates new form SanPhamDJlogTest
     */
    public SanPhamDJlogTest() {
        initComponents();
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout pnlThuocTinhSanPhamLayout = new javax.swing.GroupLayout(pnlThuocTinhSanPham);
        pnlThuocTinhSanPham.setLayout(pnlThuocTinhSanPhamLayout);
        pnlThuocTinhSanPhamLayout.setHorizontalGroup(
            pnlThuocTinhSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 1055, Short.MAX_VALUE)
        );
        pnlThuocTinhSanPhamLayout.setVerticalGroup(
            pnlThuocTinhSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 722, Short.MAX_VALUE)
        );

        jTabbedPane1.addTab("Loại sản phẩm", pnlThuocTinhSanPham);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SanPhamDJlogTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SanPhamDJlogTest().setVisible(true);
            }
        });
    }
